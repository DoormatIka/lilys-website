<script>
  ...
  const qa = [
    { question: "Who are you?", answer: "I'm Lilyn/Alice! An osu player.." },
    {
      ...
      answer: "Who shares their real name in the internet?",
    },
    {
      question: "Can you do websites for me?",
      answer: "I mean.. sure but don't expect a good product.",
    },
    {
      question: "Career?",
      answer: "osu!.. and probably software development.",
    },
...
<div id="floating-menu">
  ...
  <a href="/lilys-website" use:link id="floating-button"> Back </a>
...
>
  ...
  >
    ...
    <div class="example-grid" id="osu-play-section">
      {#each videos as video}
        <video src={video} loop width="500" class="video-section" />
      {/each}
    </div>
  </ParallaxLayer>
  ...
  <div id="start-parallax">
    ...
    >
      ...
      <button on:click={() => disableParallax = !disableParallax}>
        {#if disableParallax}
          Enable Parallax          
        {:else}
          Disable Parallax
